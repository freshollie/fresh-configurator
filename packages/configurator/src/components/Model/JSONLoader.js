/* eslint-disable */
// Credit for this goes to https://github.com/mrdoob/three.js
// Might be worth converting to TS at some point, but too
// complex for now
    ...
    Object.create(THREE.Loader.prototype),
    {
      ...
      parse: (function () {
        ...
        function loadTexture(
          ...
          const loader = manager.getHandler(fullPath);
        ...
        function parseSkin(json, geometry) {
          ...
          if (
            ...
            console.warn(
              `When skinning, number of vertices (${geometry.vertices.length}), skinIndices (${geometry.skinIndices.length}), and skinWeights (${geometry.skinWeights.length}) should match.`
            );
          }
        }
